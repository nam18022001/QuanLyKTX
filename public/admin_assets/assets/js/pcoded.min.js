...
// $("body").append('<div class=" active"><a href="mailto:hnvnam.19it3@vku.udn.vn" class="btn btn-md btn-primary"><i class="far fa-envelope" aria-hidden="true"></i> Liên hệ tổ quản lý KTX</a> </div>');
// var $window = $(window),
//     nav = $(".fixed-button");