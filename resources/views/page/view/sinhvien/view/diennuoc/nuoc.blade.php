...
<style>
.bg-dien{
    background-image: linear-gradient(90deg, rgba(72, 152, 37, 0.7), rgba(14, 140, 147, 0.721));
}
.bg-dien-alt{
    background-image: linear-gradient(-90deg, rgba(72, 152, 37, 0.7), rgba(14, 140, 147, 0.721));
}
                ...
                <div class="card prod-p-card bg-dien">
                    <div class="card-body">
                        <div class="row align-items-center m-b-25">
                            ...
                            <div class="col-auto">
                                <i class="fas fa-tint text-c-red f-18"></i>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-dien">
                    <div class="card-body text-center">
                        <div class="align-items-center m-b-25">
                                ...
                                <h4 class="m-b-5 ">{{$nuoc->tongtien}}<small><sup>VNĐ</sup></small></h4>
