<header class="navbar pcoded-header navbar-expand-lg navbar-light headerpos-fixed">
	<div class="m-header">
		...
		<a href="{{url('sinh-vien')}}" class="b-brand">
			<img src="{{asset('logo/Green3.png')}}" width="20%" alt="" class="">
		</a>
	</div>
				...
				<div class="dropdown drp-user">
					<a href="#" class="a" data-toggle="dropdown">
						@if (!empty(Auth::guard('sinh_vien')->user()->avatar))
							<img src="{{asset('admin_assets/upload')}}/{{Auth::guard('sinh_vien')->user()->avatar}}" width="40" class="img-radius" alt="User-Profile-Image">
							@else
					...
					<div class="dropdown-menu dropdown-menu-right profile-notification">
						<div class="pro-head">
							...
							<img src="{{asset('logo/green3.png')}}" width="40" class="img-radius" alt="User-Profile-Image">
						@endif
							<span>{{Auth::guard('sinh_vien')->user()->Ten}}</span>
							<a href="{{url('sinh-vien/dang-xuat')}}" class="dud-logout" title="Logout">
