    ...
    <div class="area-1">
        <div class="tabs-container">
            ...
            <ul class="nav nav-tabs" id="ariaTabs" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link" id="nav-tab-2" data-toggle="tab" href="#tab-2" role="tab" aria-controls="tab-2" aria-selected="false"><i class="fas fa-th"></i> Nội quy</a>
                </li>
                {{-- <li class="nav-item">
                ...
                <div class="tab-pane fade show active" id="tab-2" role="tabpanel" aria-labelledby="tab-2">
                    <ul class="list-unstyled li-space-lg first">
                        <li class="media">
                            ...
                            <div class="media-body"><strong>Đúng giờ</strong> theo quy định 11h đêm sẽ đóng cổng ko cho phép ra vào</div>
                        </li>
                        <li class="media">
                            <div class="media-bullet">2</div>
                            <div class="media-body"><strong>Sạch sẽ</strong> phòng ở phải gọn gàng, sạch sẽ</div>
                        </li>
                        <li class="media">
                            <div class="media-bullet">3</div>
                            <div class="media-body"><strong>Nấu ăn</strong> không cho phép nấu ăn trong phòng tránh cháy nổ</div>
                        </li>
                    </ul>
                    <ul class="list-unstyled li-space-lg last">
                        <li class="media">
                            <div class="media-bullet">4</div>
                            <div class="media-body"><strong>Giữ gìn</strong> tự bảo quản tài sản của cá nhân</div>
                        </li>
                        <li class="media">
                            <div class="media-bullet">5</div>
                            <div class="media-body"><strong>Hoạt động</strong> tham gia vào các hoạt động chung của KTX</div>
                        </li>
                        <li class="media">
                            <div class="media-bullet">6</div>
                            <div class="media-body"><strong>Bảo quản</strong> bảo quản tài sản chung của KTX</div>
                        </li>
                    </ul>
                </div> <!-- end of tab-pane -->
                <!-- end of tab -->
