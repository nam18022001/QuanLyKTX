                    ...
                    <div class="swiper-container card-slider">
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div class="card">
                                    <img class="card-image" src="page_assets/images/testimonial-1.jpg" alt="alternative">
                                    <div class="card-body">
                            ...
                            <div class="swiper-slide">
                                <div class="card">
                                    <img class="card-image" src="page_assets/images/testimonial-2.jpg" alt="alternative">
                                    <div class="card-body">
                            ...
                            <div class="swiper-slide">
                                <div class="card">
                                    <img class="card-image" src="page_assets/images/testimonial-3.jpg" alt="alternative">
                                    <div class="card-body">
                            ...
                            <div class="swiper-slide">
                                <div class="card">
                                    <img class="card-image" src="page_assets/images/testimonial-4.jpg" alt="alternative">
                                    <div class="card-body">
                            ...
                            <div class="swiper-slide">
                                <div class="card">
                                    <img class="card-image" src="page_assets/images/testimonial-5.jpg" alt="alternative">
                                    <div class="card-body">
                            ...
                            <div class="swiper-slide">
                                <div class="card">
                                    <img class="card-image" src="page_assets/images/testimonial-6.jpg" alt="alternative">
                                    <div class="card-body">
