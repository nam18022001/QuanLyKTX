...
@endsection
@section('content')
<form action="{{url('quan-ly/thong-bao/gui')}}" method="POST" enctype="multipart/form-data">
  {{ csrf_field() }}
      ...
      <div class="card card-primary card-outline">
        ...
        <div class="card-body">
          <div class="form-group">
            <input class="form-control" type="email" name="email" placeholder="Email trường của sinh viên: "value="{{$sua->sinhvien->email}}">
          </div>
          <div class="form-group">
              ...
              <div class="mailbox-attachment-info">
                <span class="mailbox-attachment-name"><p class="filename"><i class="fa fa-paperclip"></i> {{ $value->filename }}</p></span>
                    <span class="mailbox-attachment-size">
                      ...
                      <input style="display: none;" type="text "id="xoa{{$u}}" name="id" value="{{ $value->id}}"><label for="xoa{{$u}}"><i class="fas fa-trash btn btn-outline-danger btn-xl"></i></label>
                    </span>
              </div>
            </div>
          </div>
...
$.ajax(
{
    url: 'http://greendormitory.com/quan-ly/thong-bao/file-discard/xoa/' + id,
    type: 'GET', 
    // dataType: "JSON",
    data: {
        "id": id 
