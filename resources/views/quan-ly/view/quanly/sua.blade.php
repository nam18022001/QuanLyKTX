...
<div class="mt-5">
    <h4 class="header-title mb-3">Cập nhật quản lý {{$sua->Ten}}</h4>

    <form class="form-horizontal mt-3" action="{{url('quan-ly/sua')}}/{{$sua->id}}" method="POST" enctype="multipart/form-data">
        {{ csrf_field() }}
        <div class="" id="p-c1">
